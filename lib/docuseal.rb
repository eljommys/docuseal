...
module Docuseal
  ...
  PRODUCT_URL = 'https://www.rackslabs.com'
  PRODUCT_EMAIL_URL = ENV.fetch('PRODUCT_EMAIL_URL', PRODUCT_URL)
  NEWSLETTER_URL = "#{PRODUCT_URL}/solutions".freeze
  ENQUIRIES_URL = "#{PRODUCT_URL}/contact".freeze
  PRODUCT_NAME = 'Racks'
  DEFAULT_APP_URL = ENV.fetch('APP_URL', 'http://localhost:3000')
  GITHUB_URL = 'https://github.com/Racks-Labs'
  TWITTER_URL = 'https://x.com/rackslabs'
  TWITTER_HANDLE = '@rackslabs'
  CHATGPT_URL = "#{PRODUCT_URL}/chat".freeze
  SUPPORT_EMAIL = 'info@rackslabs.com'
